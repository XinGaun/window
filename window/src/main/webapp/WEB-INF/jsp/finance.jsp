	...
	* Name 载入数据
	...
	$('#wu-datagrid').datagrid({
		...
		columns:[[ 
					...
					{field:'FIRSTMONEY',title:'审批金额',width:100,height:0,align:'right',sortable:true},
					{field:'STAFFNAME',title:'认证人姓名',width:100,height:0,align:'right',sortable:true},
					{field:'USERNAME',title:'审核人姓名',width:100,height:0,align:'right',sortable:true},
					{field:'LOANDATE',title:'贷款日期',width:100,height:0,align:'right',sortable:true},
					{field:'CHECKTIME',title:'审核日期',width:100,height:0,align:'right',sortable:true},
					{field:'CREDIBILITY',title:'诚信度',width:50,height:0,align:'right',sortable:true},
		    		{field:'STATUSNAME',title:'审核状态',width:50,height:0}    
				]]     
			}); 
</script>
