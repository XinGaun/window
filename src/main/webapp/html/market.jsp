    ...
    <nav class="navbar navbar-inverse navbar-static-top site-nav" role="navigation"> 
     <div class="container"> 
      ...
      <ul class="nav navbar-nav site-nav-sns"> 
       <li class="site-nav-sns-phone"><span class="navbar-text">欢迎：400-921-9218</span></li> 
       <li>  </li> 
       <li> </li> 
       <li> </li> 
      </ul> 
       ...
       <div class="container"> 
        ...
        <div class=" navbar-collapse navbar-ex1-collapse sl-nav"> 
         <ul class="nav navbar-nav main-menu navbar-right"> 
          <!--menus--> 
          <li class="main-link-list"> <a class="main-link" href="market.html"> <span class="main-link-text">我要投资</span> </a> </li> 
          <li class="main-link-list"> <a class="main-link" href="borrow.html"> <span class="main-link-text">我要借款</span> </a> </li> 
          ...
          <li class="main-link-list"> <a class="main-link" href="about.html"> <span class="main-link-text">关于我们</span> </a> </li> 
         </ul> 
        </div> 
        <!-- /.navbar-collapse --> 
       </div> 
      ...
      <div class="row"> 
       ...
       <div class="recharge-tab col-xs-3"> 
        <div class="recharge-ctrl" ng-if="isAuthenticated()" ng-cloak="">
         ...
         <a href="member_pay.html"><span class="recharge-icon"></span></a> 
        </div> 
